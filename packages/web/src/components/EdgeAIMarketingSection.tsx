...
import { Cpu, Zap, Shield, Brain, Network, ArrowRight, ExternalLink } from "lucide-react";
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <Badge className="mb-4 bg-gradient-to-r from-purple-100 to-indigo-100 text-purple-700 dark:from-purple-900 dark:to-indigo-900 dark:text-purple-300 border-purple-300 dark:border-purple-700">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-300 max-w-3xl mx-auto mb-6">
            Real-time, local processing with AI-powered matching. Deploy edge nodes for ultra-low
            latency reconciliation while maintaining cloud intelligence.
          </p>
        </div>
          ...
          <div className="text-center">
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Button asChild size="lg" variant="outline">
                <Link href="/edge-ai">Learn More About Edge AI</Link>
              </Button>
            </div>
