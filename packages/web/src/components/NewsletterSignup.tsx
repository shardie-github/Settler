...
export function NewsletterSignup() {
  ...
  return (
    <Card
      className={cn("bg-gradient-to-r from-primary-600 to-electric-indigo border-0", "shadow-xl")}
      elevation="lg"
    >
      <CardHeader className="text-center">
        <CardTitle className="text-2xl md:text-3xl text-white mb-2">Stay Updated</CardTitle>
