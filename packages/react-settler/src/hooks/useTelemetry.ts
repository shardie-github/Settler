...
export function useTelemetry(componentName?: string) {
  ...
  const track = useCallback(
    (eventName: string, properties?: Record<string, unknown>) => {
      ...
      const event: TelemetryEvent = {
        ...
        name: eventName,
        ...(properties
          ? ({ properties: globalConfig.scrubPII ? scrubPII(properties) : properties } as {
  ...
  const trackError = useCallback(
    (error: Error, context?: Record<string, unknown>) => {
      ...
      const errorTelemetry: ErrorTelemetry = {
        ...
        ...(context
          ? ({ context: globalConfig.scrubPII ? scrubPII(context) : context } as {
  ...
  const trackPerformance = useCallback(
    (metrics: PerformanceMetrics, component?: string) => {
      ...
      const event: TelemetryEvent = {
        ...
        ...(component || componentName
          ? { context: { component: component || componentName } as TelemetryContext }
          : {}),
      };
