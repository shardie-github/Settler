...
import {
  ...
  getJobPerformance,
  getMatchAccuracy,
} from "../infrastructure/query-optimization";
...
router.get(
  ...
  async (req: AuthRequest, res: Response) => {
    try {
      ...
      handleRouteError(res, error, "Failed to get reconciliation summary", 500, {
...
router.get(
  ...
  async (req: AuthRequest, res: Response) => {
    try {
      ...
      handleRouteError(res, error, "Failed to get job performance", 500, {
        jobId: req.params.jobId,
      });
    }
  }
...
router.get(
  ...
  async (req: AuthRequest, res: Response) => {
    try {
      ...
      handleRouteError(res, error, "Failed to get match accuracy", 500, {
        jobId: req.params.jobId,
      });
    }
  }
