# Settler Business Model & Strategy
...
Settler operates a **dual-license business model** with open-source (OSS) and commercial tiers, designed to drive adoption while creating sustainable revenue through platform integrations and enterprise features.
...
1. **Settler API SaaS**
   - Usage-based pricing (per reconciliation job)
   - Subscription tiers (Starter, Pro, Enterprise)
   - Estimated ARPU: $200-$2,000/month

2. **React.Settler Commercial**
   - Commercial License: $99/month or $990/year
   - Enterprise License: Custom pricing ($5K-$50K+/year)
   - Estimated ARPU: $1,188/year (Commercial) or $25K+/year (Enterprise)

3. **Professional Services** (Optional)
   - Implementation consulting
   - Custom integrations
   - Training and onboarding
   - Estimated: $5K-$50K per engagement
...
4. Upgrade to Commercial ($99/month)

**Value Prop:** "Start free, upgrade when you need integrations"
...
4. Use Settler API SaaS for backend

**Value Prop:** "Save weeks of development time"
...
**Value Prop:** "Enterprise-grade solution with dedicated support"
...
2. **Clear Upgrade Path** - Make it easy to convert
3. **Platform Integrations** - Provide clear value
4. **Developer Experience** - Best-in-class DX
5. **Community Growth** - Build engaged community
