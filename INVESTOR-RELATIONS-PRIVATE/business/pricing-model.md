# How We Make Money: Settler Pricing Model
...
- **Cost:** $99/month = $0.02 per transaction
...
- **Cost:** $299/month = $0.006 per order
...
- **Cost:** Custom pricing based on volume and requirements
...
**Automatic Billing:** Overage charges are automatically added to your monthly bill.
...
1. **Product-Led Growth**: Developers try before they buy
2. **Viral Loops**: Free users become advocates
3. **Data Collection**: Learn usage patterns and improve product
4. **Market Education**: Teach developers about reconciliation
...
**Q: What counts as a reconciliation?**  
A: One reconciliation = matching one source transaction with one target transaction.

**Q: What happens if I exceed my plan limit?**  
A: You're automatically charged $0.01 per reconciliation over your limit. No service interruption.
...
A: Email support with SLA based on your plan. Enterprise includes dedicated account manager.

**Q: Can I get a custom plan?**  
A: Yes! Contact sales@settler.io for custom pricing based on your needs.
