# Settler Pricing Page

**Live URL:** [settler.io/pricing](https://settler.io/pricing)  
...
**Example:** Shopify store processing 500 orders/month with Stripe payments reconciliation. Daily automated reports. **Cost:** $29/month = $0.058 per order.

**[Start Free Trial →](https://settler.io/signup?plan=starter)**
...
**Example:** SaaS company processing 5,000 transactions/month with Stripe + PayPal + QuickBooks reconciliation. Real-time webhook reconciliation. Advanced matching rules. **Cost:** $99/month = $0.02 per transaction.

**[Start Free Trial →](https://settler.io/signup?plan=growth)**
...
**Example:** E-commerce platform processing 50,000 orders/month with multiple payment providers (Stripe, PayPal, Square) and multiple accounting systems (QuickBooks, NetSuite). Multi-currency operations. **Cost:** $299/month = $0.006 per order.

**[Start Free Trial →](https://settler.io/signup?plan=scale)**
...
**Example:** Financial services company processing millions of transactions/month with multiple subsidiaries. Strict compliance requirements (SOC 2, PCI-DSS, HIPAA). **Cost:** Custom pricing based on volume and requirements.

**[Contact Sales →](https://settler.io/contact?plan=enterprise)**
...
**Automatic Billing:** Overage charges are automatically added to your monthly bill. No service interruption.
...
**Example:** Growth plan includes 90 days. Need 180 days total? **Cost:** $10/month for additional 90 days.
...
**Example:** Need custom adapter for internal ERP system? **Cost:** $500 + $50/month.
...
- **Email:** [sales@settler.io](mailto:sales@settler.io)
- **Calendar:** [settler.io/contact](https://settler.io/contact)
- **Phone:** (Coming soon)

**We'll work with you to create a plan that fits your needs.**

---

## Start Free Today

**No credit card required. Start reconciling in 5 minutes.**
